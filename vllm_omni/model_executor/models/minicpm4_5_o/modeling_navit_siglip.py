...
class SiglipVisionConfig(PretrainedConfig):
    ...
    >>> # Initializing a SiglipVisionModel (with random weights)
    ...
    Args:
        image_embeds (`torch.FloatTensor` of shape `(batch_size, output_dim)`
            *optional* returned when model is initialized with
            ...
            The image embeddings obtained by applying the projection
        ...
        attentions (`tuple(torch.FloatTensor)`, *optional*, returned when
            ...
            compute the weighted average in the self-attention
            heads.
    """
...
class SiglipFlashAttention2(SiglipAttention):
    ...
    def _flash_attention_forward(
        ...
        # for RoCm is bumped to 2.1. For details, please see the comment
        # in LlamaFlashAttention2 __init__.
    ...
    def forward(
        ...
        Args:
            ...
            attention_mask (`torch.FloatTensor`):
                ...
                where padding elements are indicated by very large
                negative values.
